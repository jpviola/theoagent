...
import { Book, Newspaper, Heart, FileText, Users, HelpCircle, Gift, Facebook, Twitter, Instagram, Youtube, Map, PanelRightClose, PanelRightOpen, ArrowRight } from 'lucide-react';
      ...
      <div className={`p-4 flex flex-col h-full ${isCollapsed ? 'items-center' : ''}`}>
        ...
        {!isCollapsed && (
          <motion.div 
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="pt-6 border-t border-amber-100 dark:border-gray-800 mt-auto"
          >
